/*
generated at Fri May 15 16:27:13 2020
...
static void yyreduce(NODEPTR_TYPE p, int goalnt)
{
  ...
  switch(eruleno) {
	case 1: /* file: PROGRAM(finaldecls,FUNCTION(END(ID,INT),FARGS(NIL,main))) */
		fprintf(stderr, "0x%p: line 40: file: PROGRAM(finaldecls,FUNCTION(END(ID,INT),FARGS(NIL,main)))\n",(void*)p);
#line 40 "minor.brg"
{ fprintf(yyout, pfIMM pfPOP pfLEAVE pfRET, 0); }
		break;
	case 2: /* file: MODULE(finaldecls) */
		fprintf(stderr, "0x%p: line 41: file: MODULE(finaldecls)\n",(void*)p);
#line 41 "minor.brg"
{}
		break;
	case 3: /* finaldecls: decls */
		fprintf(stderr, "0x%p: line 43: finaldecls: decls\n",(void*)p);
#line 43 "minor.brg"
{ fprintf(yyout, pfGLOBL pfTEXT pfALIGN pfLABEL pfENTER , "_main", pfFUNC, "_main", 0); }
		break;
	case 4: /* decls: NIL */
		fprintf(stderr, "0x%p: line 45: decls: NIL\n",(void*)p);
#line 45 "minor.brg"

		break;
	case 5: /* decls: gdecls */
		fprintf(stderr, "0x%p: line 46: decls: gdecls\n",(void*)p);
#line 46 "minor.brg"
{}
		break;
	case 6: /* gdecls: DECL(gdecls,decl) */
		fprintf(stderr, "0x%p: line 48: gdecls: DECL(gdecls,decl)\n",(void*)p);
#line 48 "minor.brg"
{}
		break;
	case 7: /* gdecls: DECL(NIL,decl) */
		fprintf(stderr, "0x%p: line 49: gdecls: DECL(NIL,decl)\n",(void*)p);
#line 49 "minor.brg"
{}
		break;
	case 8: /* decl: VAR(vardecl) */
		fprintf(stderr, "0x%p: line 51: decl: VAR(vardecl)\n",(void*)p);
#line 51 "minor.brg"
{}
		break;
	case 9: /* decl: FUNCTION(END(ID,INT),FARGS(fvars,eqbody)) */
		fprintf(stderr, "0x%p: line 52: decl: FUNCTION(END(ID,INT),FARGS(fvars,eqbody))\n",(void*)p);
#line 52 "minor.brg"
{}
		break;
	case 10: /* decl: FUNCTION(END(ID,INT),FARGS(NIL,eqbody)) */
		fprintf(stderr, "0x%p: line 53: decl: FUNCTION(END(ID,INT),FARGS(NIL,eqbody))\n",(void*)p);
#line 53 "minor.brg"
{}
		break;
	case 11: /* decl: NIL */
		fprintf(stderr, "0x%p: line 54: decl: NIL\n",(void*)p);
#line 54 "minor.brg"

		break;
	case 12: /* fvar: NUMBER(ID,NIL) */
		fprintf(stderr, "0x%p: line 56: fvar: NUMBER(ID,NIL)\n",(void*)p);
#line 56 "minor.brg"
{}
		break;
	case 13: /* fvar: STRING(ID,NIL) */
		fprintf(stderr, "0x%p: line 57: fvar: STRING(ID,NIL)\n",(void*)p);
#line 57 "minor.brg"
{}
		break;
	case 14: /* fvar: ARRAY(ID,INTS(vdim,NIL)) */
		fprintf(stderr, "0x%p: line 58: fvar: ARRAY(ID,INTS(vdim,NIL))\n",(void*)p);
#line 58 "minor.brg"
{}
		break;
	case 15: /* fvars: ARGS(NIL,fvar) */
		fprintf(stderr, "0x%p: line 60: fvars: ARGS(NIL,fvar)\n",(void*)p);
#line 60 "minor.brg"
{}
		break;
	case 16: /* fvars: ARGS(fvars,fvar) */
		fprintf(stderr, "0x%p: line 61: fvars: ARGS(fvars,fvar)\n",(void*)p);
#line 61 "minor.brg"
{}
		break;
	case 17: /* vardecl: NUMBER(ID,eqint) */
		fprintf(stderr, "0x%p: line 63: vardecl: NUMBER(ID,eqint)\n",(void*)p);
#line 63 "minor.brg"
{}
		break;
	case 18: /* vardecl: STRING(ID,eqstr) */
		fprintf(stderr, "0x%p: line 64: vardecl: STRING(ID,eqstr)\n",(void*)p);
#line 64 "minor.brg"
{}
		break;
	case 19: /* vardecl: ARRAY(ID,INTS(vdim,eqvec)) */
		fprintf(stderr, "0x%p: line 65: vardecl: ARRAY(ID,INTS(vdim,eqvec))\n",(void*)p);
#line 65 "minor.brg"
{}
		break;
	case 20: /* vdim: INT */
		fprintf(stderr, "0x%p: line 67: vdim: INT\n",(void*)p);
#line 67 "minor.brg"
{}
		break;
	case 21: /* vdim: NIL */
		fprintf(stderr, "0x%p: line 68: vdim: NIL\n",(void*)p);
#line 68 "minor.brg"

		break;
	case 22: /* eqint: NIL */
		fprintf(stderr, "0x%p: line 70: eqint: NIL\n",(void*)p);
#line 70 "minor.brg"

		break;
	case 23: /* eqint: INT */
		fprintf(stderr, "0x%p: line 71: eqint: INT\n",(void*)p);
#line 71 "minor.brg"
{}
		break;
	case 24: /* eqint: INT */
		fprintf(stderr, "0x%p: line 72: eqint: INT\n",(void*)p);
#line 72 "minor.brg"
{}
		break;
	case 25: /* eqstr: NIL */
		fprintf(stderr, "0x%p: line 74: eqstr: NIL\n",(void*)p);
#line 74 "minor.brg"

		break;
	case 26: /* eqstr: chars */
		fprintf(stderr, "0x%p: line 75: eqstr: chars\n",(void*)p);
#line 75 "minor.brg"
{}
		break;
	case 27: /* chars: CHARS(NIL,char) */
		fprintf(stderr, "0x%p: line 77: chars: CHARS(NIL,char)\n",(void*)p);
#line 77 "minor.brg"
{ char *lb = mklbl(++lbl); fprintf(yyout, pfRODATA pfALIGN pfLABEL pfCHAR, lb , RIGHT_CHILD(p)->value.i); }
		break;
	case 28: /* chars: CHARS(chars,char) */
		fprintf(stderr, "0x%p: line 78: chars: CHARS(chars,char)\n",(void*)p);
#line 78 "minor.brg"
{}
		break;
	case 29: /* char: INT */
		fprintf(stderr, "0x%p: line 80: char: INT\n",(void*)p);
#line 80 "minor.brg"
{}
		break;
	case 30: /* char: CHAR */
		fprintf(stderr, "0x%p: line 81: char: CHAR\n",(void*)p);
#line 81 "minor.brg"
{}
		break;
	case 31: /* char: STR */
		fprintf(stderr, "0x%p: line 82: char: STR\n",(void*)p);
#line 82 "minor.brg"
{}
		break;
	case 32: /* eqvec: NIL */
		fprintf(stderr, "0x%p: line 84: eqvec: NIL\n",(void*)p);
#line 84 "minor.brg"

		break;
	case 33: /* eqvec: ints */
		fprintf(stderr, "0x%p: line 85: eqvec: ints\n",(void*)p);
#line 85 "minor.brg"
{}
		break;
	case 34: /* ints: INT */
		fprintf(stderr, "0x%p: line 87: ints: INT\n",(void*)p);
#line 87 "minor.brg"
{}
		break;
	case 35: /* ints: INTS(ints,INT) */
		fprintf(stderr, "0x%p: line 88: ints: INTS(ints,INT)\n",(void*)p);
#line 88 "minor.brg"
{}
		break;
	case 36: /* eqbody: NIL */
		fprintf(stderr, "0x%p: line 90: eqbody: NIL\n",(void*)p);
#line 90 "minor.brg"

		break;
	case 37: /* eqbody: body */
		fprintf(stderr, "0x%p: line 91: eqbody: body\n",(void*)p);
#line 91 "minor.brg"
{}
		break;
	case 38: /* main: START(fvars,instrs) */
		fprintf(stderr, "0x%p: line 93: main: START(fvars,instrs)\n",(void*)p);
#line 93 "minor.brg"
{}
		break;
	case 39: /* main: START(NIL,instrs) */
		fprintf(stderr, "0x%p: line 94: main: START(NIL,instrs)\n",(void*)p);
#line 94 "minor.brg"
{}
		break;
	case 40: /* body: START(fvars,STMT(instrs,ret)) */
		fprintf(stderr, "0x%p: line 96: body: START(fvars,STMT(instrs,ret))\n",(void*)p);
#line 96 "minor.brg"
{}
		break;
	case 41: /* body: START(NIL,STMT(instrs,ret)) */
		fprintf(stderr, "0x%p: line 97: body: START(NIL,STMT(instrs,ret))\n",(void*)p);
#line 97 "minor.brg"
{}
		break;
	case 42: /* ret: RETURN(NIL) */
		fprintf(stderr, "0x%p: line 99: ret: RETURN(NIL)\n",(void*)p);
#line 99 "minor.brg"
{}
		break;
	case 43: /* ret: RETURN(expr) */
		fprintf(stderr, "0x%p: line 100: ret: RETURN(expr)\n",(void*)p);
#line 100 "minor.brg"
{}
		break;
	case 44: /* ret: NIL */
		fprintf(stderr, "0x%p: line 101: ret: NIL\n",(void*)p);
#line 101 "minor.brg"

		break;
	case 45: /* loop: ret */
		fprintf(stderr, "0x%p: line 103: loop: ret\n",(void*)p);
#line 103 "minor.brg"
{}
		break;
	case 46: /* loop: REPEAT */
		fprintf(stderr, "0x%p: line 104: loop: REPEAT\n",(void*)p);
#line 104 "minor.brg"
{}
		break;
	case 47: /* loop: STOP */
		fprintf(stderr, "0x%p: line 105: loop: STOP\n",(void*)p);
#line 105 "minor.brg"
{}
		break;
	case 48: /* block: STMT(instrs,loop) */
		fprintf(stderr, "0x%p: line 107: block: STMT(instrs,loop)\n",(void*)p);
#line 107 "minor.brg"
{}
		break;
	case 49: /* instrs: NIL */
		fprintf(stderr, "0x%p: line 109: instrs: NIL\n",(void*)p);
#line 109 "minor.brg"

		break;
	case 50: /* instrs: STMT(instrs,instr) */
		fprintf(stderr, "0x%p: line 110: instrs: STMT(instrs,instr)\n",(void*)p);
#line 110 "minor.brg"
{ /*fprintf(yyout, );*/ }
		break;
	case 51: /* instr: FI(THEN(IF(expr,block),elifs),else) */
		fprintf(stderr, "0x%p: line 112: instr: FI(THEN(IF(expr,block),elifs),else)\n",(void*)p);
#line 112 "minor.brg"
{}
		break;
	case 52: /* instr: FOR(UNTIL(expr,expr),STEP(block,expr)) */
		fprintf(stderr, "0x%p: line 113: instr: FOR(UNTIL(expr,expr),STEP(block,expr))\n",(void*)p);
#line 113 "minor.brg"
{}
		break;
	case 53: /* instr: EXCL(expr) */
		fprintf(stderr, "0x%p: line 114: instr: EXCL(expr)\n",(void*)p);
#line 114 "minor.brg"
{ fprintf(yyout, pfEXTRN pfCALL pfTRASH, "_prints", "_prints", 3);}
		break;
	case 54: /* instr: expr */
		fprintf(stderr, "0x%p: line 115: instr: expr\n",(void*)p);
#line 115 "minor.brg"
{}
		break;
	case 55: /* instr: CARD(expr,lval) */
		fprintf(stderr, "0x%p: line 116: instr: CARD(expr,lval)\n",(void*)p);
#line 116 "minor.brg"
{}
		break;
	case 56: /* elifs: NIL */
		fprintf(stderr, "0x%p: line 118: elifs: NIL\n",(void*)p);
#line 118 "minor.brg"

		break;
	case 57: /* elifs: ELIF(elifs,IF(expr,block)) */
		fprintf(stderr, "0x%p: line 119: elifs: ELIF(elifs,IF(expr,block))\n",(void*)p);
#line 119 "minor.brg"
{}
		break;
	case 58: /* else: NIL */
		fprintf(stderr, "0x%p: line 121: else: NIL\n",(void*)p);
#line 121 "minor.brg"

		break;
	case 59: /* else: block */
		fprintf(stderr, "0x%p: line 122: else: block\n",(void*)p);
#line 122 "minor.brg"
{}
		break;
	case 60: /* lval: ID */
		fprintf(stderr, "0x%p: line 124: lval: ID\n",(void*)p);
#line 124 "minor.brg"
{}
		break;
	case 61: /* lval: PARE(expr,ID) */
		fprintf(stderr, "0x%p: line 125: lval: PARE(expr,ID)\n",(void*)p);
#line 125 "minor.brg"
{}
		break;
	case 62: /* expr: chars */
		fprintf(stderr, "0x%p: line 127: expr: chars\n",(void*)p);
#line 127 "minor.brg"
{ /*fprintf(yyout, pfADDR);*/ }
		break;
	case 63: /* expr: lval */
		fprintf(stderr, "0x%p: line 128: expr: lval\n",(void*)p);
#line 128 "minor.brg"
{}
		break;
	case 64: /* expr: IN */
		fprintf(stderr, "0x%p: line 129: expr: IN\n",(void*)p);
#line 129 "minor.brg"
{}
		break;
	case 65: /* expr: ADDR(lval) */
		fprintf(stderr, "0x%p: line 130: expr: ADDR(lval)\n",(void*)p);
#line 130 "minor.brg"
{}
		break;
	case 66: /* expr: expr */
		fprintf(stderr, "0x%p: line 131: expr: expr\n",(void*)p);
#line 131 "minor.brg"
{}
		break;
	case 67: /* expr: ADD(expr,expr) */
		fprintf(stderr, "0x%p: line 132: expr: ADD(expr,expr)\n",(void*)p);
#line 132 "minor.brg"
{}
		break;
	case 68: /* expr: SUB(expr,expr) */
		fprintf(stderr, "0x%p: line 133: expr: SUB(expr,expr)\n",(void*)p);
#line 133 "minor.brg"
{}
		break;
	case 69: /* expr: MUL(expr,expr) */
		fprintf(stderr, "0x%p: line 134: expr: MUL(expr,expr)\n",(void*)p);
#line 134 "minor.brg"
{}
		break;
	case 70: /* expr: DIV(expr,expr) */
		fprintf(stderr, "0x%p: line 135: expr: DIV(expr,expr)\n",(void*)p);
#line 135 "minor.brg"
{}
		break;
	case 71: /* expr: MOD(expr,expr) */
		fprintf(stderr, "0x%p: line 136: expr: MOD(expr,expr)\n",(void*)p);
#line 136 "minor.brg"
{}
		break;
	case 72: /* expr: POW(expr,expr) */
		fprintf(stderr, "0x%p: line 137: expr: POW(expr,expr)\n",(void*)p);
#line 137 "minor.brg"
{}
		break;
	case 73: /* expr: EQUAL(expr,expr) */
		fprintf(stderr, "0x%p: line 138: expr: EQUAL(expr,expr)\n",(void*)p);
#line 138 "minor.brg"
{}
		break;
	case 74: /* expr: NE(expr,expr) */
...
{}
		break;
	case 75: /* expr: GE(expr,expr) */
		fprintf(stderr, "0x%p: line 140: expr: GE(expr,expr)\n",(void*)p);
#line 140 "minor.brg"
{}
		break;
	case 76: /* expr: LE(expr,expr) */
...
{}
		break;
	case 77: /* expr: MIN(expr,expr) */
		fprintf(stderr, "0x%p: line 142: expr: MIN(expr,expr)\n",(void*)p);
#line 142 "minor.brg"
{}
		break;
	case 78: /* expr: MAX(expr,expr) */
		fprintf(stderr, "0x%p: line 143: expr: MAX(expr,expr)\n",(void*)p);
#line 143 "minor.brg"
{}
		break;
	case 79: /* expr: AND(expr,expr) */
...
{}
		break;
	case 81: /* expr: NOT(expr) */
		fprintf(stderr, "0x%p: line 146: expr: NOT(expr)\n",(void*)p);
#line 146 "minor.brg"
{}
		break;
	case 82: /* expr: uminus(expr) */
...
{}
		break;
	case 83: /* expr: EQ(expr,lval) */
		fprintf(stderr, "0x%p: line 148: expr: EQ(expr,lval)\n",(void*)p);
#line 148 "minor.brg"
{}
		break;
	case 84: /* expr: CURVE(ID,exprs) */
		fprintf(stderr, "0x%p: line 149: expr: CURVE(ID,exprs)\n",(void*)p);
#line 149 "minor.brg"
{}
		break;
	case 85: /* exprs: COMMA(expr,NIL) */
		fprintf(stderr, "0x%p: line 151: exprs: COMMA(expr,NIL)\n",(void*)p);
#line 151 "minor.brg"
{}
		break;
	case 86: /* exprs: COMMA(expr,exprs) */
		fprintf(stderr, "0x%p: line 152: exprs: COMMA(expr,exprs)\n",(void*)p);
#line 152 "minor.brg"
{}
		break;
	default: break;
